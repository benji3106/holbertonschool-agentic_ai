        ...
        <section id="contact-section" className="py-24 bg-black">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
                    {/* CTAs */}
                    <a href="https://www.holbertonschool.com" target="_blank" rel="noopener noreferrer" className="px-4 py-2 font-semibold rounded-md bg-violet-500 hover:bg-violet-600 shadow-lg shadow-violet-500/40 text-slate-50 transition-colors">
                        Enroll at Holberton School →
                    </a>
                    <a href="#about-section" className="px-4 py-2 font-semibold rounded-md border border-slate-800 bg-slate-950 hover:bg-slate-900 text-slate-50 transition-colors">
