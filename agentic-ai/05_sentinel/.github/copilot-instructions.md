...
## Règles absolues
- Avant d'écrire la moindre ligne de code d'un dashboard, tu DOIS récupérer les issues du dépôt ciblé avec l'outil `get_github_issues`. Si l'outil échoue ou n'est pas disponible, tu t'arrêtes et tu le signales. Tu n'inventes jamais de données d'issues.
